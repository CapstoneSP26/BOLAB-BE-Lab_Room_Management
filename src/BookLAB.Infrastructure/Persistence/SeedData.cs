    ...
    public static class SeedData
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Schedule>().HasData(
                new Schedule { Id = schedule1Id, LecturerId = user1Id, LabRoomId = 1, ScheduleType = ScheduleType.Booking, ScheduleStatus = ScheduleStatus.Active, StartTime = new DateTimeOffset(2025, 2, 1, 8, 0, 0, TimeSpan.Zero), EndTime = new DateTimeOffset(2025, 2, 1, 10, 0, 0, TimeSpan.Zero), CreatedAt = new DateTimeOffset(2025, 1, 1, 0, 0, 0, TimeSpan.Zero), CreatedBy = user1Id, IsActive = true, IsDeleted = false },
                new Schedule { Id = schedule2Id, LecturerId = user2Id, LabRoomId = 2, ScheduleType = ScheduleType.Booking, ScheduleStatus = ScheduleStatus.Active, StartTime = new DateTimeOffset(2025, 2, 2, 13, 0, 0, TimeSpan.Zero), EndTime = new DateTimeOffset(2025, 2, 2, 15, 0, 0, TimeSpan.Zero), CreatedAt = new DateTimeOffset(2025, 1, 2, 0, 0, 0, TimeSpan.Zero), CreatedBy = user2Id, IsActive = true, IsDeleted = false },
                new Schedule { Id = schedule3Id, LecturerId = user3Id, LabRoomId = 3, ScheduleType = ScheduleType.Scheduled, ScheduleStatus = ScheduleStatus.Active, StartTime = new DateTimeOffset(2025, 2, 3, 9, 0, 0, TimeSpan.Zero), EndTime = new DateTimeOffset(2025, 2, 3, 10, 30, 0, TimeSpan.Zero), CreatedAt = new DateTimeOffset(2025, 1, 3, 0, 0, 0, TimeSpan.Zero), CreatedBy = user3Id, IsActive = true, IsDeleted = false }
            );
