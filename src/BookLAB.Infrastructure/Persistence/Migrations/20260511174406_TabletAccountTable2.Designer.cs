...
namespace BookLAB.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260511174406_TabletAccountTable2")]
    partial class TabletAccountTable2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookLAB.Domain.Entities.TabletAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TabletAccounts", (string)null);
                });
            ...
            modelBuilder.Entity("BookLAB.Domain.Entities.TabletAccount", b =>
                {
                    b.HasOne("BookLAB.Domain.Entities.LabRoom", "LabRoom")
                        .WithOne("TabletAccount")
                        .HasForeignKey("BookLAB.Domain.Entities.TabletAccount", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
